...
print("⏳ Collecting behavioral + emotional data...")
...
while True:
    ...
    if results.multi_face_landmarks:
        ...
        smoothed_smile = np.mean(smile_buffer)
        smile_values.append(smoothed_smile)
        ...
        cv2.putText(frame,
                    f"Smile: {round(smoothed_smile,3)}",
                    (30,40),
...
print("\n📊 FINAL RESULTS")
print("Average Smile:", round(avg_smile,3))
print("Smile Variance:", round(smile_variance,5))
print("Average Movement:", round(avg_movement,5))
print("Emotion Stability Score:", round(emotion_stability,3))
...
print("\n🔥 Final Behavioral + Emotional Confidence Score:", score)
